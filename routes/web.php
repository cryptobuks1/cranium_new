...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('/upload_csv_to_table', 'SupplierDotController@upload_csv_to_table')->name('upload_csv_to_table');
    Route::post('/update_data_using_csv', 'SupplierDotController@update_data_using_csv')->name('update_data_using_csv');
    ...
    ## Supplier Dryer Product Edit view
    //Route::get('/dryerproductlist/{id}', 'SupplierDryersController@dryerproductlist')->name('dryerproductlist');
    
    ## Supplier Dryer Product Edit request
    Route::put('/updatedryer', 'SupplierDryersController@updatedryer')->name('updatedryer');
    
    ## Sync Dryer Product With Master
    Route::get('/syncwithmaster/{id}', 'MasterProductController@syncwithmaster')->name('syncwithmaster');   
